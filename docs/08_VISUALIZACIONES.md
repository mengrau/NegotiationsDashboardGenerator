...
| Presentaciones sin ventas por categoría | ¿Dónde se concentra la ausencia de venta? | `noSalesAnalysis.byCategory` | donut ≤6, treemap ≤18, barra >18 | Abre drill-down; fallback conserva acción. Standard. |
